...
/**
 * EtudiantSearch represents the model behind the search form about `frontend\models\EtudiantModel`.
 */
class EtudiantSearch extends EtudiantModel
{
    ...
    {
        return [
            [['cin', 'nom', 'prenom', 'date_naissance', 'email', 'adresse', 'logo'], 'safe'],
            [['telephone', 'num_inscri', 'id_filiere', 'id_groupe'], 'integer'],
        ];
    }
