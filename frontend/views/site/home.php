        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <strong><i class="glyphicon glyphicon-blackboard"></i> Lavagna</strong>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  <ul class="timeline">
          ...
          <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
            <footer class="footer">
              <div class="container">
                <div class="navbar-header">
                  <button type="button" class="navbar-toggle collapsed label-warning" data-toggle="collapse" data-target="#chatmenu" aria-expanded="false" aria-controls="navbar">
                          ...
                          <div class="panel-heading">
                            ...
                            <div class="btn-group pull-right">
                              <button type="button" class="btn btn-warning btn-xs dropdown-toggle" data-toggle="dropdown">
                                <i class="glyphicon glyphicon-remove"></i></b>
                              </button>
                            </div>
                            <div class="btn-group pull-right">
                              <button type="button" class="btn btn-warning btn-xs dropdown-toggle" data-toggle="dropdown">
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <div class="chat-panel panel-warning">
                                ...
                                <li class="dropdown">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-comment"></i> Colleghi</a>
                                  <ul class="dropdown-menu">
                                    <!-- /.panel -->
                                    <div class="chat-panel panel panel-warning">
                                      <div class="panel-heading">
                                        <strong><i class="glyphicon glyphicon-comment"></i> Colleghi</strong>
                                        <div class="btn-group pull-right">
                                    ...
                                    <div class="panel-footer">
                                      <div class="input-group">
                                        <input id="btn-input" type="text" class="form-control input-sm" placeholder="Cerca..." />
                                        <span class="input-group-btn">
                                          <button class="btn btn-warning btn-sm" id="btn-chat">
